...
ReactDOM.render(React.createElement(app_1.default, null), appContainer);
...
var React = __webpack_require__(3);
var TodoApi = __webpack_require__(36);
var App = /** @class */ (function (_super) {
    tslib_1.__extends(App, _super);
    function App(props) {
        var _this = _super.call(this, props) || this;
        _this.renderTodoItems = function () {
            return _this.state.todoItems.map(function (item, idx) {
                return React.createElement("div", { key: idx }, item.name);
            });
        };
    ...
    App.prototype.componentWillMount = function () {
        ...
        TodoApi.getAllTodoItems()
            .then(function (items) {
            _this.setState(tslib_1.__assign({}, _this.state, { todoItems: items, isLoading: false }));
        });
    };
    App.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("div", null, this.state.isLoading && "Loading, please wait..."),
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(16);
var apiClient_1 = __webpack_require__(37);
function getAllTodoItems() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiClient = apiClient_1.ApiClient.getInstance();
                    return [4 /*yield*/, apiClient.get('api/todo')];
                case 1:
                    result = _a.sent();
...
var ApiClient = /** @class */ (function () {
    ...
    ApiClient.createInstance = function () {
